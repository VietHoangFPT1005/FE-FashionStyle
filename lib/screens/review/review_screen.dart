...
class _ReviewScreenState extends State<ReviewScreen> {
        ...
        builder: (ctx, setModalState) => Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Chia sẻ trải nghiệm của bạn với sản phẩm này',
                style: TextStyle(color: Colors.grey.shade600, fontSize: 13)),
              const SizedBox(height: 20),
              RatingBar.builder(
                initialRating: 5, minRating: 1, maxRating: 5,
                    ...
                    try {
                      final request = CreateReviewRequest(
                          ...
                          comment: commentCtrl.text.trim().isNotEmpty
                              ? commentCtrl.text.trim() : null);
                      final res = await sl.reviewService.createReview(widget.productId, request);
                      if (res.success) {
                        Navigator.pop(ctx);
                        Helpers.showSnackBar(context, 'Đã gửi đánh giá!');
                        _loadReviews();
                      } else {
                        Helpers.showSnackBar(context, res.message ?? 'Gửi thất bại', isError: true);
                      }
                    } catch (_) {
                      Helpers.showSnackBar(context, 'Gửi đánh giá thất bại', isError: true);
                    }
                  },
  ...
  Widget _buildBody() {
    ...
    if (_error != null) return AppErrorWidget(message: _error!, onRetry: _loadReviews);
        ...
        Expanded(
          child: _filteredReviews.isEmpty
              ? EmptyWidget(
                  ...
                  actionText: 'Viết đánh giá đầu tiên',
                  onAction: _showWriteReview,
                )
              : RefreshIndicator(
                  color: Colors.black,
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (_, i) => _buildReviewItem(_filteredReviews[i]),
                  ),
                ),
        ),
      ],
        ...
        children: [
          Column(
            children: [
              ...
              RatingBarIndicator(
                rating: _averageRating, itemCount: 5, itemSize: 18,
                itemBuilder: (_, __) => const Icon(Icons.star, color: Colors.amber),
              ),
          ...
          Padding(
            ...
            child: FilterChip(
              ...
              labelStyle: TextStyle(
                color: _filterRating == null ? Colors.white : Colors.black87,
                fontSize: 12),
          ...
          ...List.generate(5, (i) {
            ...
            return Padding(
              ...
              child: FilterChip(
                ...
                selectedColor: Colors.black,
                labelStyle: TextStyle(
                  color: _filterRating == star ? Colors.white : Colors.black87,
                  fontSize: 12),
